...
// create CRUD routes
// app.get('/api/vehicles', (req, res) => { // good to go - USING .then and .catch promise
//     pool
...
app.get('/api/vehicles', async (req, res) => { // USING async/await with try/catch promise
    try {
        const result = await pool.query('SELECT * FROM vehicles'); // awaiting promise (pool.query) to be resolved
